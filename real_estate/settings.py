...
#         'NAME': 'great_estate',
#         'USER': 'root',
#         'PASSWORD': 'erkin050402',
#         'HOST': 'localhost', # it must be changed when database is located in different machine, need an API address in that case. In our case we are using local machine
#         'PORT': '3306',
#     }
# }
